...
(function(){
	...
	*/
	...
	function solarToLunar(_year,_month,_day){
		...
		var res = {
			zodiac : getYearZodiac(GanZhiYear), //change
			GanZhiYear : getLunarYearName(GanZhiYear), //change
			GanZhiMonth : getLunarMonthName(year,GanZhiMonth), //change
			GanZhiDay : getLunarDayName(year,month,day), //change
			//放假安排：0無特殊安排，1工作，2放假
