            ...
            <div class="col-4 center_vec_other">
                ...
                <div class="row-2">
                    <div class="col-3">
                        ...
                        <div class="row-6">
                            <button id="MovingStarsTenYears" class="btn btn-success" type="button" onclick="ClearMovingStars(this.id.replace('_MovingStarsTenYears',''), 'tenYear')">清除大運</button>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="row-6">
                        ...
                        <div class="row-6">
                            <button id="ClearMovingStarsYear"class="btn btn-success" type="button" onclick="ClearMovingStars(this.id.replace('_ClearMovingStarsYear',''), 'year')">清除流年</button>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="row-6">
                        ...
                        <div class="row-6">
                            <button id="ClearMovingStarsMonth"class="btn btn-success" type="button" onclick="ClearMovingStars(this.id.replace('_ClearMovingStarsMonth',''), 'month')">清除流月</button>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="row-6">
                        ...
                        <div class="row-6">
                            <button id="ClearMovingStarsDay"class="btn btn-success" type="button" onclick="ClearMovingStars(this.id.replace('_ClearMovingStarsDay',''), 'day')">清除流日</button>
                        </div>
                    </div>
                </div>
            </div>
