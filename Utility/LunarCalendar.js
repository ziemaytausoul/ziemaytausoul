...
(function () {
  ...
  function getLunarMonthName(year, month, offset) {
    ...
    //console.log((year - 1890) * 12 + month + 12 + offset)
  ...
  var LunarCalendar = {
    ...
    getLunarYear: getLunarYearName,
    getLunarMonth: getLunarMonthName,
    getLunarDay: getLunarDayName,
  };
