...
const data_convertion = require(__dirname.replace(
  "finding_position",
  "data_convertion.json"
));
const preparation_for_stars = require(__dirname.replace(
  "finding_position",
  "preparation_for_stars.json"
));
...
module.exports.findForteenMainStars = function (birth_day, type_of_module) {
  const zie_may_start_point =
    preparation_for_stars["zie_may_start_point"][type_of_module];
  ...
  const tim_foo_start_point =
    preparation_for_stars.tim_foo_start_point[zie_may_end_point.toString()];
  ...
  return {
    ...
    tai_yueng: {
      position: zie_may_end_point > 3 ?
        zie_may_end_point - 3 : zie_may_end_point - 3 + 12,
    },
    mau_koo: {
      position: zie_may_end_point > 4 ?
        zie_may_end_point - 4 : zie_may_end_point - 4 + 12,
    },
    tim_toun: {
      position: zie_may_end_point > 5 ?
        zie_may_end_point - 5 : zie_may_end_point - 5 + 12,
    },
    lin_zaen: {
      position: zie_may_end_point > 8 ?
        zie_may_end_point - 8 : zie_may_end_point - 8 + 12,
    },
    tim_foo: {
    ...
    tam_long: {
      position: tim_foo_start_point > 10 ?
        tim_foo_start_point + 2 - 12 : tim_foo_start_point + 2,
    },
    guoy_moon: {
      position: tim_foo_start_point > 9 ?
        tim_foo_start_point + 3 - 12 : tim_foo_start_point + 3,
    },
    tim_sueng: {
      position: tim_foo_start_point > 8 ?
        tim_foo_start_point + 4 - 12 : tim_foo_start_point + 4,
    },
    tim_leung: {
      position: tim_foo_start_point > 7 ?
        tim_foo_start_point + 5 - 12 : tim_foo_start_point + 5,
    },
    chey_sa: {
      position: tim_foo_start_point > 6 ?
        tim_foo_start_point + 6 - 12 : tim_foo_start_point + 6,
    },
    pob_gaun: {
      position: tim_foo_start_point > 2 ?
        tim_foo_start_point + 10 - 12 : tim_foo_start_point + 10,
    },
  };
};
...
module.exports.findTwelveCheongSun = function (type_of_module, type_of_people) {
  const start_point =
    preparation_for_stars.twelve_cheong_sun_start_point[type_of_module];
  let result = {
    cheong_sun: {
      position: "",
    },
  ...
  if (type_of_people == "01" || type_of_people == "10") {
    ...
    result["kwun_tai"]["position"] =
      start_point > 2 ? start_point - 2 : start_point - 2 + 12;
    result["lin_kwun"]["position"] =
      start_point > 3 ? start_point - 3 : start_point - 3 + 12;
    result["tai_mon"]["position"] =
      start_point > 4 ? start_point - 4 : start_point - 4 + 12;
    result["soi"]["position"] =
      start_point > 5 ? start_point - 5 : start_point - 5 + 12;
    result["bang"]["position"] =
      start_point > 6 ? start_point - 6 : start_point - 6 + 12;
    result["say"]["position"] =
      start_point > 7 ? start_point - 7 : start_point - 7 + 12;
    result["mou"]["position"] =
      start_point > 8 ? start_point - 8 : start_point - 8 + 12;
    result["chue"]["position"] =
      start_point > 9 ? start_point - 9 : start_point - 9 + 12;
    result["toi"]["position"] =
      start_point > 10 ? start_point - 10 : start_point - 10 + 12;
    result["yeung"]["position"] =
      start_point > 11 ? start_point - 11 : start_point - 11 + 12;
  } else if (type_of_people == "11" || type_of_people == "00") {
    result["cheong_sun"]["position"] = start_point;
    result["moo_yau"]["position"] = start_point == 12 ? 1 : start_point + 1;
    result["kwun_tai"]["position"] =
      start_point < 11 ? start_point + 2 : start_point + 2 - 12;
    result["lin_kwun"]["position"] =
      start_point < 10 ? start_point + 3 : start_point + 3 - 12;
    result["tai_mon"]["position"] =
      start_point < 9 ? start_point + 4 : start_point + 4 - 12;
    result["soi"]["position"] =
      start_point < 8 ? start_point + 5 : start_point + 5 - 12;
    result["bang"]["position"] =
      start_point < 7 ? start_point + 6 : start_point + 6 - 12;
    result["say"]["position"] =
      start_point < 6 ? start_point + 7 : start_point + 7 - 12;
    result["mou"]["position"] =
      start_point < 5 ? start_point + 8 : start_point + 8 - 12;
    result["chue"]["position"] =
      start_point < 4 ? start_point + 9 : start_point + 9 - 12;
    result["toi"]["position"] =
      start_point < 3 ? start_point + 10 : start_point + 10 - 12;
    result["yeung"]["position"] =
      start_point < 2 ? start_point + 11 : start_point + 11 - 12;
  }
  return result;
};
...
/** 人/地盤-十二宮 **/
module.exports.AdjustTwelveSections = function (
  FirstSec_Result,
  StartPoint,
  Section
) {
...
/** 人/地盤-十二長生 **/
module.exports.AdjustTwelveCheongSun = function (
  FirstSec_Result,
  typeOfModule,
  typeOfPeople,
  Section
...
/** 人/地盤-十四星 **/
module.exports.AdjustMainStars = function (
  FirstSec_Result,
  typeOfModule,
  birth_day,
  Section
...
/** 人/地盤 - 天使 **/
module.exports.adjustTimSze = function (
  Result,
  travel_point,
  type_of_people,
  Section
...
/** 人/地盤 - 天傷 **/
module.exports.adjustTimShoin = function (
  Result,
  travel_point,
  type_of_people,
  Section
