...
/** 大耗 **/
module.exports.findDaiHau = function (startPointDaiHau, birth_year) {
  if (isNaN(startPointDaiHau)) {
    throw exception("finDaiHau: not a number");
  }
  let daiHau_position = parseInt(startPointDaiHau, 10);
  let even = parseInt(birth_year, 10) % 2 == 0;
  if (even) {
    daiHau_position -= 1;
  } else {
    daiHau_position += 1;
